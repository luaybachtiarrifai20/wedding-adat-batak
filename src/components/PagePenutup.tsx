  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center px-5 pt-10 pb-12 gap-6">
        <div className="reveal w-full h-[20px]"></div>

        <p
          className="reveal text-white text-[13px] text-center leading-relaxed"
          style={{ fontFamily: 'Poppins, sans-serif' }}
        >
          Merupakan suatu kehormatan dan kebahagiaan bagi kami apabila Bapak/Ibu/Saudara/i dapat berkenan hadir dan memberikan do'a restu
        </p>

        <h2
          className="reveal text-[#F8BB63] text-[24px] font-normal"
        ...
        <img src={ornamentOrnamen} alt="Ornament" className="reveal w-full" />

        <div className="reveal w-full flex flex-col items-center gap-4 mt-4">
          <p
